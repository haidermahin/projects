...
<html>
  <head>
    <title>MoviePlex | Groups & Parties</title>
    <meta charset="utf-8">
  ...
  <div id="wrapper">
    ...
    <p>Thank you for inquiring for a <?php echo $_POST["type"] ?> at <?php echo $_POST["location"] ?> on <?php echo date("D M jS", strtotime($_POST["date"])) ?>.</p>
    <p>We will get back to you within 24 hours to discuss accomodations and pricing. See you there!<br><br></p>
    </div>
    ...
    function update() {
        ...
        $eventdate = date("D M jS", strtotime($_POST["date"]));
        ...
        $sql = "INSERT INTO `parties`(`name`,`phone`,`email`,`attendees`,`type`,`location`,`date`) VALUES ('$name','$phone','$email',$attendees,'$type','$location','$eventdate');";
