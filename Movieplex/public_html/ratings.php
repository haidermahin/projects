...
<body>
  <div id="wrapper">    
    ...
    <!-- Display the data-->
    <div class="main">
    <p style="text-align: center;"><img src="https://cdn.jotfor.ms/img/check-icon.png" alt="" width="128" height="128" /><br><br>
    Thank you for your ratings.<br><br>
    Your input will update our movie ratings and theater location ratings.<br><br>
    You entered: <br><br>
    '<?php echo $_POST["movie-rate"] ?>' is a
    <u><?php echo $_POST["movie-star"] ?></u> star movie that you are
    <u><?php echo $_POST["movie-recommend"] ?></u> to recommend to a friend.<br><br>
    You are 
    <u><?php echo $_POST["location-recommend"] ?></u> to recommend '<?php echo $_POST["location"] ?>' to a friend.</p>
    <br><br>
    </div>
    ...
    function update() {
        ...
        $movie = $_POST["movie-rate"];
        $movie_rating = $_POST["movie-star"];        
        $location = $_POST["location"];
        $location_rating = $_POST["location-satisfaction"];
        ...
        $sql = "INSERT INTO `ratings`(`movie`, `movie_rating`, `location`, `location_rating`) VALUES ('$movie','$movie_rating','$location','$location_rating');";
